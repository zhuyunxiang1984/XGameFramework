...
public class ILRuntimeCLRBinding
{
   [MenuItem("ILRuntime/通过自动分析热更DLL生成CLR绑定")]
    static void GenerateCLRBindingByAnalysis()
    {
        ...
        //string dllpath = "Assets/StreamingAssets/HotFix_Project.dll";
        string generatePath = "Assets/ILRuntime/Generated";
        string dllpath = $"{Application.dataPath}/../Library/ScriptAssemblies/HotFixProject.dll";
